export const dataSlide: any = [
  {
    id: 1,
    img: "/images/manual/regisManual.jpg",
    text: "1",
    facebook: "คนที่1",
    title:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates, magnam repellendus? Cumque, iusto repudiandae eius eum dolores, magni fugit tempore ut soluta aspernatur maxime perspiciatis corrupti fuga autem, laborum quae dolore error! Quae illum ducimus molestias modi quis saepe iusto rerum voluptas ratione ipsam? Repellendus odio ad dolorum qui quasi eligendi aliquid ipsum sint molestiae voluptatibus? Illo sunt numquam molestias reiciendis? Dignissimos aliquam quos molestiae, quas quod repudiandae similique eligendi quidem officiis ipsa, commodi quae tempore eos dicta laboriosam itaque accusantium sed fugit neque? Inventore omnis iste consequatur ducimus at. Nam ullam laboriosam repellat asperiores saepe consectetur itaque facilis ipsum?",
  },
  {
    id: 2,
    text: "2",
  ...
  },
  {
    ...
    text: "3",
    facebook: "คนที่3",
    title: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eaque consequuntur laboriosam quasi. Sed distinctio voluptate sunt, minus pariatur, repellat recusandae exercitationem fuga esse officiis ipsum cum quibusdam, consequatur cupiditate quia vitae eaque voluptatem possimus labore ratione maiores rem totam! Laudantium sit adipisci magnam nulla consectetur eveniet at velit necessitatibus odit, aut recusandae libero natus architecto quasi pariatur praesentium? Illo, voluptatem error molestias nobis itaque modi animi minus. Quia, culpa neque?",
  },
  {
    id: 4,
    text: "4",
